...
# ==========================================
    ...
    with st.container():
        ...
        <div style="
            ...
            text-align: center;
        ">
            <h3 style="color: #ffffff; margin-bottom: 10px;">Schreib mir eine Nachricht</h3>
            <p style="color: #a0a0a0; font-size: 16px; margin-bottom: 20px;">
                Du hast Vorschläge, einen Bug gefunden oder möchtest einfach Feedback hinterlassen?<br>
                Erreiche mich direkt per E-Mail:
            </p>
            <a href="mailto:deine.email@beispiel.com" style="
            ...
            " onmouseover="this.style.backgroundColor='#007bc7'" onmouseout="this.style.backgroundColor='#0090ed'">
                email@beispiel.com
            </a>
        </div>
        """, unsafe_allow_html=True)