...
# API KEY SETUP
# Streamlit holt sich den Key später aus sicheren Server-Einstellungen
...
<div class="custom-navbar">
    ...
    <div class="nav-links">
        ...
        <a href="?page=contact" target="_self" class="{active_contact}">️ Kontakt</a>
    </div>
</div>
"""
...
if page == "analyse":
    ...
    with st.container():
        # Layout auf 50/50 geändert, damit Dropdowns nicht abgeschnitten werden
        ...
        with col_input1:
            ...
            # Textfeld für eigene Zusätze direkt darunter
            ...
            # Logik: Kombiniere Dropdown und Textfeld
            final_intent = ""
            
            # 1. Basis-Fokus bestimmen
            if intent_selection == search_intents[0]: # Wenn Standard gewählt ist
            ...
            # 2. Eigenen Text anhängen (falls vorhanden)
